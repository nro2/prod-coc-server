module.exports = [
  {
    ...
    description: `This Committee shall:
...
3) Advise the Senate relative to the assignment of further duties to the committees listed below, and suggest the establishment of special Senate Faculty committees.
4) Assist committees in streamlining and delegating their tasks.
5) Report at least once each year to the Senate and President.`,
    total_slots: 16,
  },
  {
    name: 'Academic Requirements Committee',
    description: `The Committee shall:
...
2) Report to the Faculty Senate at least once each year.`,
  ...
  },
  {
    ...
    description: `The Committee shall:
1) Advise the Dean of the University Library on policies concerning the library budget, collections, services, and the use of space.
2) Act as an advocate for the library on behalf of the Faculty Senate.
...
2) Establish policies, in consultation with administrative officers, as to the allotment of whatever institutional sums have been granted or appropriated for Faculty research, multi- or interdisciplinary ventures, Faculty development, Faculty improvement or evaluation of teaching and Peer Review.
...
7) Report at least once a year to the Senate, including a list of courses and program changes reviewed and approved.`,
  ...
  },
  {
    ...
    description: `The Committee shall:
1) Make recommendations to Provost and other administrators on such matters as writing placement, guidelines, and staffing for teaching writing in University Studies, writing-intensive courses, and composition courses.
...
3) Report on issue, concerns, and potential for actionable ideas.
